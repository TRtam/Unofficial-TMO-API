...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const trending = await (await page.waitForSelector("#pills-trending-boys > div")).evaluate(element => element.innerHTML)
        ...
        console.error("controllers/trending/seinen", error); return res.status(500).send("something went wrong")
    }
}